...
def _public_version(version = None):
    return version.__replace__(local = None)


def _base_version(version = None):
...
class Specifier(BaseSpecifier):
    ...
    def _get_spec_version(self = None, version = None):
        '''One element cache, as only one spec Version is needed per Specifier.'''
        pass
    # WARNING: Decompyle incomplete

    
    def _require_spec_version(self = None, version = None):
    ...
    _canonical_spec = (lambda self = None: (operator, version) = self._specif operator == '===' or version.endswith('.*'):
(operator, version)spec_version = None._require_spec_version(version)canonical_version = canonicalize_version(spec_version, strip_trailing_zero = operator != '~=')(operator, canonical_version))()
    ...
    def _compare_equal(self = None, prospective = None, spec = None):
        ...
        spec_version = None._require_spec_version(spec)
    ...
    def _compare_less_than(self = None, prospective = None, spec_str = None):
        ...
        if not prospective < spec:
            return False
        if spec.is_prerelease and prospective.is_prerelease and _base_version(prospective) == _base_version(spec):
            return False
        return True
    ...
    def _compare_greater_than(self = None, prospective = None, spec_str = None):
        ...
        if not prospective > spec:
            return False
        if spec.is_postrelease and prospective.is_postrelease and _base_version(prospective) == _base_version(spec):
            return False
    # WARNING: Decompyle incomplete

...
# File: socketserver.pyc (Python 3.12)
...
if hasattr(socket, 'AF_UNIX'):
    ...
    if hasattr(os, 'fork'):
        ...
        class ForkingUnixStreamServer(UnixStreamServer, ForkingMixIn):
            pass

        
        class ForkingUnixDatagramServer(UnixDatagramServer, ForkingMixIn):
            pass

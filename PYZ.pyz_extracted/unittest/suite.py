...
def _call_if_exists(parent, attr):
    func = getattr(parent, attr, (lambda : pass))
    func()
...
class BaseTestSuite(object):
    ...
    def __repr__(self):
        return f'''<{util.strclass(self.__class__)!s} tests={list(self)!s}>'''

    
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return NotImplemented
        return None(self) == list(other)
    ...
    def _removeTestAtIndex(self, index):
        ...
        try:
            ...
            if hasattr(test, 'countTestCases'):
                pass
            None = self, self._removed_tests += test.countTestCases(), ._removed_tests
            return None
        except TypeError:
            return None

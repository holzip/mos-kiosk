...
method_caller = first_invoke((lambda : warnings.warn('`jaraco.functools.method_caller` is deprecated, use `operator.methodcaller` instead', DeprecationWarning, stacklevel = 3)), operator.methodcaller)
...
def bypass_when(check = None, *, _op):
    '''
...
_splat_inner = (lambda args, func: pass# WARNING: Decompyle incomplete
)()
_ = (lambda args = None, func = functools.singledispatch: pass# WARNING: Decompyle incomplete
)()

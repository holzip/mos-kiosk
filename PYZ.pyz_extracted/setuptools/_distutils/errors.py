...
'''
from compilers.C.errors import CompileError
from compilers.C.errors import Error as _Error
from compilers.C.errors import LibError
from compilers.C.errors import LinkError
from compilers.C.errors import PreprocessError
